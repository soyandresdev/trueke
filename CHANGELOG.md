...
- **Each case has an owner, and the team can take notes.** An operator takes a listing (or hands it to someone else, who is told about it) and writes notes that only the team reads. The panel can show only your own cases.
