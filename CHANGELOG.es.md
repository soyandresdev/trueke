...
- **Cada caso tiene responsable y el equipo puede dejar notas.** Un operador toma una publicación (o se la pasa a otro, que se entera) y escribe notas que solo lee el equipo. El panel puede mostrar solo los casos propios.
